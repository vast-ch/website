---
metadata:
  title: 'About vast.ch — Swiss engineering studio'
...
team:
  ...
  items:
    - title: 'Frédéric Montet'
      description: 'Co-founder. PhD in Computer Science (HES-SO). Focus on data science, machine learning and forecasting. Based in Interlaken.'
      icon: 'tabler:chart-line'
      callToAction:
        variant: link
        text: LinkedIn
        href: 'https://ch.linkedin.com/in/fredmontet'
        target: _blank
        icon: 'tabler:brand-linkedin'
    - title: 'Michal Bryxí'
      description: 'Co-founder. Software engineer with a frontend focus. Previously at Puppet. Long-time Ember and JavaScript contributor. Based in Interlaken.'
      icon: 'tabler:code'
      callToAction:
        variant: link
        text: LinkedIn
        href: 'https://www.linkedin.com/in/michalbryxi/'
        target: _blank
        icon: 'tabler:brand-linkedin'
    - title: 'Yannick Lagger'
      description: 'Co-founder. Software engineer with a mobile and web background (HES-SO). Publishes apps under his own name, including Flightbook. Based in Brig.'
...
values:
  ...
  items:
    - title: 'Small team, direct contact'
      description: 'You talk to the engineers doing the work — not account managers. A small team means decisions move fast and nothing gets lost in translation.'
