...
whyUs:
  ...
  items:
    - title: 'You talk to the engineers'
      description: 'No account managers in the middle. Decisions move fast and nothing gets lost in translation.'
...
industries:
  ...
  items:
    - title: 'Energy and buildings'
      description: 'Forecasting and ML for energy systems, smart buildings, district heating and IoT data. Peer-reviewed publications and the open-source onTime library.'
      icon: 'tabler:bolt'
      callToAction:
        text: 'Learn more'
